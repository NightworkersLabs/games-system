import _deployed from '#/config/deployed.json'
import _networks from '#/config/networks.compiled.json'
import type { AvailableNetwork, CompiledNetwork, NetworksDefinition } from '#/contrib/networksCompiler'
