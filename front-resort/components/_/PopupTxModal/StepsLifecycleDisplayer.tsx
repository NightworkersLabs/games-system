...
import { BasicPopupTxWaitingStep, OnChainSecurePopupTxWaitingStep } from 'lib/store/slices/popup-tx/handler'
...
type AnyPopupTxStep = OnChainSecurePopupTxWaitingStep | BasicPopupTxWaitingStep
