...
export default function SecurePopupTxModal (props: {
  ...
  //
  return (
    <Modal isCentered isOpen={true} onClose={minimizePopupTx}>
      <ModalOverlay />
...
function SecurePopupTxSteps (props : {
  ...
  const mustExecuteTx = useMemo(() => {
    ...
    //
    return (props.popupTx.wantedAsProvable === true && activeStep === 3) ||
                (props.popupTx.wantedAsProvable === false && activeStep === 1)
  }
  , [activeStep, props.popupTx.runState, props.popupTx.wantedAsProvable])
