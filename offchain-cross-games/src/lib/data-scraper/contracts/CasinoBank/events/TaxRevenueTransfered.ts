...
import { type CasinoBank_TaxRevenueTransfered, PrismaClient } from '#prisma/client/index.js'
...
export class EDC_TaxRevenueTransfered extends EventsScraperConfiguration<CasinoBank_TaxRevenueTransfered> {
  ...
  //
  override inserter: EventsDatabaseFiller<CasinoBank_TaxRevenueTransfered> = toInsert =>
  ...
  //
  override formatter: EventsFormatter<CasinoBank_TaxRevenueTransfered> = async ({ blockNumber, args, getBlock }) =>
    ({
