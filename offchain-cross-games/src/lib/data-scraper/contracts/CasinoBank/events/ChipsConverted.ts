...
import { type CasinoBank_ChipsConverted } from "#prisma/client/index.js";
...
export class EDC_ChipsConverted extends EventsScraperConfiguration<CasinoBank_ChipsConverted> {
  ...
  //
  override inserter: EventsDatabaseFiller<CasinoBank_ChipsConverted> = (
    toInsert,
  ) =>
  ...
  //
  override formatter: EventsFormatter<CasinoBank_ChipsConverted> = async ({
    blockNumber,
    args,
    getBlock,
  }) => ({
