...
export abstract class BasicScraperEngine {
  ...
  //
  protected _waitForStopEvent$ = fromEvent(this._workerEH, BasicScraperEngine._STOP_EV_NAME).pipe(share())
  ...
  //
  protected static __log (msg: string, color: LogType = 'normal', skippedInProd = false) {
    //
