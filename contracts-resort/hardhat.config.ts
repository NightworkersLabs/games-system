...
export default {
  abiExporter: {
    ...
    flat: true,
    only: [
      'contracts/NightworkersGame.sol',
      'contracts/RedLightDistrict.sol',
      'contracts/casino/Lottery.sol',
      'contracts/casino/TableGames.sol',
      'contracts/Backroom.sol',
      'contracts/LOLLY.sol'
    ],
    spacing: 0,
    pretty: false
  ...
  networks: {
    ...
    fuji: {
      ...
      chainId: 43113,
      accounts: {
        mnemonic: '' /* ACCOUNT MNEMO GOES HERE */
      }
    },
    avalanche: {
