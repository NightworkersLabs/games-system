...
import { TrustfulOrderPayload } from "@nightworkerslabs/offchain-resort/src/lib/validator/watcher";

import type { PayableMintPrices } from "#/test/_context";
...
export class MintOrderer {
  ...
  constructor(
    ...
    daemon: TrustedValidatorDaemon,
    prices: PayableMintPrices,
  ) {
